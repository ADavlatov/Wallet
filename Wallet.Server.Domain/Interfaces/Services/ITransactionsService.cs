...
public interface ITransactionsService
{
    public Task AddTransaction(Guid userId, Guid categoryId, string? name, decimal amount,
        DateOnly date, TransactionTypes type, CancellationToken cancellationToken);
    ...
    public Task UpdateTransaction(Guid transactionId, Guid? categoryId, string? name, decimal? amount, DateOnly? date, CancellationToken cancellationToken);
