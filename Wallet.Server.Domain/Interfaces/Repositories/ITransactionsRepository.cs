...
public interface ITransactionsRepository
{
    ...
    Task<List<Transaction>> GetAllTransactionsByType(Guid userId, TransactionTypes type, 
    ...
    Task<List<Transaction>> GetTransactionsByPeriod(Guid userId, DateOnly startDate, 
        DateOnly endDate, CancellationToken cancellationToken);
    
    Task<List<Transaction>> GetTransactionsByTypeAndPeriod(Guid userId, TransactionTypes type, 
